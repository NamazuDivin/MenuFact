...
public class TestMenuFact02 {
    ...
    public static void main(String[] args) throws IngredientException {
        ...
        inventaire.ajouter(pomme, 10000);
        inventaire.ajouter(laitue, 10000);
        inventaire.ajouter(fromage, 10000);
        inventaire.ajouter(vinaigrette, 10000);
        inventaire.ajouter(sauce, 10000);
        inventaire.ajouter(bacon, 10000);
        inventaire.ajouter(patate, 10000);


        RecetteBuilder recettes = new RecetteBuilder();
        Recette plat0 = recettes.ajouterIngredient(laitue,300,"g")
                .ajouterIngredient(vinaigrette, 200, "ml")
                .build();
        Recette  plat1 = recettes.ajouterIngredient(laitue,300,"g")
                .ajouterIngredient(vinaigrette, 200, "ml")
                .ajouterIngredient(fromage, 10, "g")
                .ajouterIngredient(bacon, 10, "g")
                .build();
        Recette plat2 = recettes.ajouterIngredient(patate,1,"lb")
                .build();
        Recette plat3 = recettes.ajouterIngredient(sauce,15,"ml")
                .ajouterIngredient(patate,1,"lb")
                .build();
        Recette plat4 = recettes.ajouterIngredient(pomme, 50, "g")
                .build();
        ...
        ps1.setRecette(plat0);
        ps2.setRecette(plat1);
        ps3.setRecette(plat2);
        ps4.setRecette(plat3);
        ps5.setRecette(plat4);
